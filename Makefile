# This Makefile is for the DBIx::MultiDB extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/DBIx/MultiDB.pm]
#     AUTHOR => q[Nelson Ferraz <nferraz@gmail.com>]
#     LICENSE => q[perl]
#     NAME => q[DBIx::MultiDB]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], DBI=>q[0] }
#     VERSION_FROM => q[lib/DBIx/MultiDB.pm]
#     clean => { FILES=>q[DBIx-MultiDB-*] }
...
EXE_EXT = 
FULL_AR = /usr/bin/ar
LD = cc -mmacosx-version-min=10.5.6
...
TO_INST_PM = lib/DBIx/MultiDB.pm

PM_TO_BLIB = lib/DBIx/MultiDB.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/DBIx/MultiDB.pm $(INST_MAN3DIR)/DBIx::MultiDB.$(MAN3EXT) 
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')' -- \
	  lib/DBIx/MultiDB.pm blib/lib/DBIx/MultiDB.pm 
